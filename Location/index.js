...
t.from("h2.gps_coord,p.latitude,p.longitude,input.lati,input.longi,input.coordinates_find",{
    duration: 0.5,
    opacity: 0,
    stagger: 0.1
...
t.from("h2.inner_latitude,p.inner_latitude_info,h2.inner_longitude,p.inner_longitude_info,p.copyright",{
    opacity: 0,
    stagger: 0.3,
    x: -100
